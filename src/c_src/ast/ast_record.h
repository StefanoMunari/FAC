...
typedef struct record {
	...
	op_t op;
	/** Information on the type. This field is used only if the token is
		a type declaration */
	type_t type;
	/** A generic pointer to the value of the token, it can be:
	 * - a string identifier if the token is AST_ID
